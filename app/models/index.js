...
import licenseModel from "./license.model.js"; //Nuevo
...
db.license = licenseModel(sequelize, Sequelize); //Nuevo
...
db.user.belongsToMany(db.role, {
  ...
  foreignKey: "userId",              // Clave foránea en la tabla intermedia que referencia a usuarios
  otherKey: "roleId",                // Clave foránea en la tabla intermedia que referencia a roles
});
